...
function gf_clases_post_type() {
	...
	register_post_type( 'gf_clases', $args );

}
add_action( 'init', 'gf_clases_post_type', 0 );


function gf_instructores_post_type() {
...
add_action( 'init', 'gf_instructores_post_type', 0 );


function gf_testimoniales_post_type() {
	$labels = array(
...
add_action( 'init', 'gf_testimoniales_post_type', 0 );
?>